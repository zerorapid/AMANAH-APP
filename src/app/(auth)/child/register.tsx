...
export default function ChildRegister() {
  ...
  const handleNext = () => {
    ...
    router.push('/(auth)/child/invitation');
  }
    ...
    <SafeAreaView style={s.container}>
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={{ flex: 1 }}>
        <ScrollView contentContainerStyle={{ paddingHorizontal: 24, paddingTop: 20, paddingBottom: 40 }} keyboardShouldPersistTaps="handled">
          ...
          <Paragraph fontSize={28} fontWeight="bold" color={C.text} marginBottom={8}>Child Registration</Paragraph>
          <Paragraph color={C.muted} fontSize={15} marginBottom={32}>Enter your mobile number to get started.</Paragraph>
