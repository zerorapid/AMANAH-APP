  ...
  return (
    <SafeAreaView style={s.container}>
      <YStack flex={1} paddingHorizontal={24} paddingTop={20} gap={24}>
        ...
        <YStack gap={8}>
          <Paragraph fontSize={26} fontWeight="bold" color={C.text}>Spending Controls</Paragraph>
          <Paragraph color={C.muted} fontSize={14}>Manage merchant restrictions globally.</Paragraph>
        </YStack>
